...
| 2 | طلبات الصور | يتم إرسال إشعار للبائع والإدارة عند طلب صورة مخصصة من `productView2.js`. |
| 3 | إعدادات الإشعارات | يتم جلبها من JSON المركزي. إذا تم تعطيل إشعار معين (مثلاً تعطيل `step-shipped` للمشتري)، لن يتم إرسال الإشعار حتى لو تم الضغط على زر الشحن. |
