...
console.log('%c[ProductForm] بدء تهيئة نموذج إضافة المنتج...', 'color: blue;');
...
// Hide error messages when interacting with quantity and price fields
quantityInput.addEventListener('input', () => {
    // Improvement: Normalize Hindi digits and allow only English digits
...
priceInput.addEventListener('input', () => {
    // Improvement: Normalize Hindi digits and allow only digits and dots
...
// New: Validate Original Price field (before discount)
originalPriceInput.addEventListener('input', () => {
    // Improvement: Normalize Hindi digits
    ...
    // No error handling here as it is optional
...
form.addEventListener('submit', async (e) => {
    ...
    try {
        ...
        console.log('%c[ProductForm] تم حفظ المنتج بنجاح.', 'color: green; font-weight: bold;');
