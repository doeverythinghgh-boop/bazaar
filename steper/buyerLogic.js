...
/**
 * Extracts cancelled products for the user.
 * @function getCancelledProducts
 * @param {Array<object>} ordersData
 * @param {string} userId
 * @param {string} userType
 * @returns {Array<string>} List of cancelled product keys.
 */
...
/**
 * Extracts products ready for delivery confirmation.
 * @function getDeliveryProducts
 * @param {Array<object>} ordersData
 * @param {string} userId
 * @param {string} userType
 * @returns {Array<object>} List of product objects (items).
 */
